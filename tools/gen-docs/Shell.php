 ...
 * version-switcher are intentionally dropped, along with the JS they need; only the theme-toggle
 * behavior ships.
 */
final class Shell
{
    public function __construct(private readonly string $cssBase)
    {
    }
    ...
    private function head(string $base, string $title): string
    {
        return '<head>'
            ...
            . '<title>' . self::esc($title) . ' · Milpa Core</title>'
    ...
    /** Topbar: brand + theme-toggle + GitHub link only — search and version-switcher are P2 non-goals. */
    private function topbar(): string
    {
        return '<header class="mui-docs__topbar">'
            . '<a class="mui-docs__brand" href="/">'
            . '<svg aria-hidden="true" width="20" height="20" viewBox="0 0 60 60">'
            . '<g fill="var(--oro-300)">'
            ...
            . '<a class="mui-btn mui-btn--ghost mui-btn--icon" href="https://github.com/milpa-lat/milpa" aria-label="Milpa on GitHub">'
    ...
    private function footer(): string
    {
        return '<footer class="docs-footer">'
            ...
            . '<p class="docs-footer__legal">© 2026 Milpa · Apache-2.0</p>'
            . '</footer>';
    }
